...
// -----------------------------------------------------------------------
// Identification:
// Program Name - CopyPdseMemberBin.groovy
// Programmer   - Valter de Siqueira (Valtinho)
// Country      - Brazil 
// -----------------------------------------------------------------------
// Description:
// Copy PROGRAMS binary executable from a PDSE to other PDSE it is useful for 
...
// -- Look for CopyPdseMemberBin in the list
// ------------------------------------------------------------------------
...
def memberCopy = new TSOExec().command("OCOPY INDD(IN) OUTDD(OUT) LOAD")
